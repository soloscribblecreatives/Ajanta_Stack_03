...
function toCaptureTime(page_id){	
	...
	if(nextSlideNo <= 8){ //Total slides present
	// alert(nextSlideNo);
...
function set_pg_content(pg_id){
	...
	switch(pg_id){
		...
		break;
		case 7:
		content='<link rel="stylesheet" type="text/css" href="slide7/slide7.css" media="screen"/><div class="background"><img src="slide7/1.jpg" width="1366" height="1024" alt=""/></div>';
		break;
		case 8:
		content='<link rel="stylesheet" type="text/css" href="slide8/slide8.css" media="screen"/><div class="background"><img src="slide8/1.jpg" width="1366" height="1024" alt=""/></div>';
		break;
	}
